          ...
          <div className={styles.trusted}>
            <div className={styles.trusted1}>
              ...
              <Tabs variant='soft-rounded' colorScheme='green'>
                <TabList className={styles.tabListTabs}>
                  <Tab>
                    <SunIcon />
                ...
                <TabPanels className={styles.trusted3main}>
                  <TabPanel className={styles.trusted3}>
                  ...
                  <TabPanel className={styles.trusted3}>
                    <div className={styles.trusted31}>
                      <img
                        src="https://assets-global.website-files.com/6257f2528a39952d4e8af286/6257f2528a39957dde8af4f0_firms.jpg"
                        alt=""
                      />
                    </div>
                    <div className={styles.trusted32main}>
                      <div className={styles.trusted32}>
                        ...
                        <img
                          src="https://assets-global.website-files.com/6257f2528a39952d4e8af286/6257f2528a39956ef28af373_00_Hasanco_Logo-01-1024x116-p-500.png"
                          alt=""
                        />
                        <p>
                          See how creative agency group <strong> Hasan & Partners </strong> leverages Timely’s automation to manage capacity, report on utilization, and protect employees from overworking.
                        </p>
                        <a href="#">Hasan & Partners case study</a>
                      </div>
                    </div>
                  </TabPanel>
                  ...
                  <TabPanel className={styles.trusted3}>
                    <div className={styles.trusted31}>
                      <img src="https://embed-ssl.wistia.com/deliveries/e000e37f98e60b84c350a123c0e69e035bc7e09f.webp?image_crop_resized=640x338" alt="Video Thumbnail" />
                    </div>
                    <div className={styles.trusted32main}>
                      <div className={styles.trusted32}>
                        <h3>“With an accurate record of how long project tasks take, we can estimate our performance against competitors to offer competitive pricing that we know is profitable.”
                        </h3>
                        <img
                          src="https://assets-global.website-files.com/6257f2528a39952d4e8af286/6257f2528a3995016f8af2aa_yummy.png"
                          alt=""
                        />
                        <p>
                          See how web agency <strong> Yummygum </strong> leverages Timely’s automation to bill clients accurately, maximize project profitability and optimize internal processes.
                        </p>
                        <a href="#">Yummygum case study</a>
                      </div>
                    </div>
                  </TabPanel>
                  ...
                  <TabPanel className={styles.trusted3}>
                    <div className={styles.trusted31}>
                      <img
                        src="https://assets-global.website-files.com/6257f2528a39952d4e8af286/6257f2528a39956c768af4fe_freelancers.jpg"
                        alt=""
                      />
                    </div>
                    <div className={styles.trusted32main}>
                      <div className={styles.trusted32}>
                        <h3>
                          “As a ‘solopreneur’ it's great to get an overview of all your activities. I can see exactly how much time I actually spend on each client and improve my estimates for future proposals.”
                        </h3>
                        <img
                          src="https://assets-global.website-files.com/6257f2528a39952d4e8af286/6257f2528a3995005c8af519_alana.svg"
                          alt=""
                        />
                        <p>
                          See how interior architect <strong> Alana Flick </strong> leverages Timely’s automation to bill clients accurately and drive efficiency without ever leaving her flow.
                        </p>
                        <a href="#">Alana Flick case study</a>
                      </div>
                    </div>
                  </TabPanel>
                  ...
                  <TabPanel className={styles.trusted3}>
                    <div className={styles.trusted31}>
                      <img
                        src="https://assets-global.website-files.com/6257f2528a39952d4e8af286/6257f2528a3995b6f18af4fd_inter.jpg"
                        alt=""
                      />
                    </div>
                    <div className={styles.trusted32main}>
                      <div className={styles.trusted32}>
                        <h3>
                          “Timely has helped us bridge the visibility gap created by remote working. No other time tracking app offered such accuracy or simplicity.”
                        </h3>
                        <img
                          src="https://assets-global.website-files.com/6257f2528a39952d4e8af286/6257f2528a3995f92e8af2bf_boston.png"
                          alt=""
                        />
                        <p>
                          See how Timely’s automation helps the <strong> City of Boston </strong> accurately report on all youth development time for objective payroll and grant auditing while working remotely.
                        </p>
                        <a href="#">City of Boston case study</a>
                      </div>
                    </div>
                  </TabPanel>
                </TabPanels>
