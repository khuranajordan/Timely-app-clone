  ...
  return (
    <div className={styles.footer}>
      <div className={styles.footer1}>
        <h3>Designed by <span style={{fontWeight: "bold"}}>vikings</span> in Oslo, Norway 🇳🇴</h3>
        <img src="" alt="" />
        <img style={{marginTop:"25px", width:"62px", height:"63px"}}
          src="https://assets-global.website-files.com/6257f2528a39952d4e8af286/6257f2528a39957b258af61b_ship.svg"
          alt=""
        />
        <img style={{marginTop:"-25px", marginBottom:"50px"}}
